...
class Checkout extends React.Component {
    ...
    renderNow() {
        return ( <
            ...
            div className = "col-2" >
            <
            button id = "btnPreorder"
            type = "button"
            class = "btn form-control dropdown-toggle"
            ng - disabled = "deliveryTimeDisabled"
            uib - dropdown - toggle = ""
            aria - haspopup = "true"
            aria - expanded = "false"
            disabled = "disabled" >
            ...
            nbsp; < span class = "caret m-l" > < /span> <
            /button> <
            /div> <
            /div>
        )
    ...
    render() {
        return ( <
            ...
            <
            label className = "col-lg-11 " > Cook Door < /label> <
            ...
            name = "inlineRadioOptions"
            id = "inlineRadio2"
            value = "Pre-order for later"
            onClick = { this.onClickLater }
            />

            <
            label className = "form-check-label"
            for = "inlineRadio2" > Pre - order
            for later < /label> <
            /div> <
            ...
            data - target = "#collapseOne" > Add special requests here < /h6> <
            /div>
            ...
            rows = "3"
            placeholder = "eg.if you have a food allergy or a request for the driver" > < /textarea> <
            ...
            <
            button type = "submit"
            className = " btn btn-sm text-success border-success " > REDEEM < /button> <
            /div>
            ...
            for = "inlineRadio3" > < RiVisaLine className = "me-1 text-primary border"
            size = { 30 }
            /> <GrAmex className="me-1 text-primary border"  size={30} / > Debit / Credit Card < /label>

            <
            /div> <
            /button> <
            div id = 'collapsediv1'
            className = ' card container collapse div1' >
            <
            div >
            ...
            <
            label class = "form-check-label"
            for = "inlineRadio4" > < IoCashOutline className = "text-warning me-1"
            size = { 20 }
            />Cash</label >
            <
            /div> <
            ...
            <
            div style = {
                { marginLeft: "20px" } } > EGP 239, 99 <
            /div> <
            /div> <
            Link to = "/checkout"
            type = "btn"
            className = "btn btn-success " > PROCEED TO CHECKOUT < /Link> <
            /div> <
            /div> <
            /div> <
            /div> <
