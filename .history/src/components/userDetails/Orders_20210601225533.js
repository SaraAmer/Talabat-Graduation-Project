    ...
    render() {
        ...
        return ( <
            ...
            li className = "list-group-item" > < Link > < p style = {
                { color: "#FF5900" } } > Saved Addresses < /p></Link >
            <
            /li> <
            li className = "list-group-item" > < Link > < p style = {
            ...
            img style = {
                { height: "100px" } }
            src = "https://www.vskills.in/certification/tutorial/wp-content/uploads/2013/01/geolocation.jpg" > < /img> <
            ...
            id = "exampleModalLabel3" > Add New Address < /h5> <
            button type = "button"
            ...
            div >
            <
            GoogleMap style = { mapStyles }
            bootstrapURLKeys = {
                { key: 'GOOGLE_MAPS_API_KEY' } }
            center = {
                { lat: 5.6219868, lng: -0.1733074 } }
            zoom = { 14 } >
            <
            ...
            <
            h5 className = "modal-title"
            id = "exampleModalLabel4" > Add New Address < /h5> <
            button type = "button"
            className = "close border-0"
            data - dismiss = "modal"
            aria - label = "Close" >
            ...
            <
            label
            for = "inputEmail4" > Contact Details < /label> <
            input type = "phone"
            ...
            <
            label
            for = "inputPassword4" > Landing Number < /label> <
            input type = "text"
            className = "form-control"
            id = "inputPassword4"
            placeholder = "Landing Number(optional)" / >
            <
            /div> <
            /div> <
            div className = "row" >
            <
            label
            for = "inputAddress" > Address Details < /label> <
            ...
            className = "form-control"
            id = "inputAddress"
            placeholder = "Addess Title(optional)" / >
            <
            /div> <
            /div>	 <
            div className = "row" >
            ...
            className = "form-control"
            id = "inputAddress2"
            placeholder = "Assitional Directions(optional)" / >
            <
            /div> <
            /div> <
            div className = "modal-footer" >
            ...
            data - target = "#exampleModal3"
            data - dismiss = "modal" > < i className = "bi bi-geo-alt" > < /i>View Map <
            /button> <
            /div> <
            ...
            data - toggle = "modal"
            className = "btn btn-primary "
            data - dismiss = "modal" > Save Address <
            /button> <
            /div>
