...
class Header extends React.Component {
    render() {
        return ( <
            ...
            <
            label className = "navbar-toggler  d-md-none"
            type = "button"
            ...
            /ul> <
            /div> <
            div className = " container float-right  d-none d-md-block"
            style = {
                { paddingLeft: "200px" } } >
            <
            ...
            <
            li className = " nav-item dropdown text-white m-2 dropleft" >
            <
            p data - toggle = "dropdown" > < RiShoppingBasket2Fill / > < /p> <
            div className = "dropdown-menu"
            style = {
                { padding: "15px", paddingBottom: "0px" } } >
            <
            div class = "card"
            style = {
                { width: "18rem" } } >
            ...
            h6 class = "card-subtitle m-2 text-muted" > Cook Door - shatby < /h6> <
            p class = "card-text" > Some quick example text to build on the card title and make up the bulk of the card 's content.</p> <
            Link type = "btn"
            className = "btn btn-success m-2" > PROCEED to CHECKOUT < /Link> <
            /div> <
            /div> <
            /div> <
            /li>
            ...
            LoginUSer / >
            <
            /div> { /* <div className="modal-footer"></div> */ } <
            /div> <
            /div> <
            /div> <
            /div> <
            ...
            exact component = { PartnerRegister } >
            < /Route>
