...
router.get("/street/:street", (req, res, next) => {
  ...
  Restaurant.find({ "address.street": street })
    .exec()
    .then((docs) => {
      const response = {
        count: docs.length,
...
router.put("/:resId", upload.single("img"), (req, res, next) => {
  ...
  Restaurant.findOne({ _id: id })
    ...
    .then((rest) => {
      ...
      rest.numberOfBranches = req.body.numberOfBranches
        ? req.body.numberOfBranches
        : rest.numberOfBranches;
      rest.country = req.body.country ? req.body.country : rest.country;
      rest.minOrderAmount = req.body.minOrderAmount
        ? req.body.minOrderAmount
        : rest.minOrderAmount;
      rest.workingHours = req.body.workingHours
        ? req.body.workingHours
        : rest.workingHours;
      rest.serviceCharge = req.body.serviceCharge
